using Kitware.VTK;
using System;
// input file is C:\VTK\Graphics\Testing\Tcl\EnSightOfficeBin.tcl
// output file is AVEnSightOfficeBin.cs
/// <summary>
/// The testing class derived from AVEnSightOfficeBin
/// </summary>
public class AVEnSightOfficeBinClass
{
  /// <summary>
